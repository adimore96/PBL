...
<body>
    ...
    <div class="container  col-10 col-md-8 col-lg-6 mb-3 p-5 ">
        ...
        <form class="row g-3 d-flex" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
        <div class="col-md-4 ms-2">
        <label for="validationDefault01" class="form-label ">Name </label>  
            <input type="text" name="username" id="validationDefault01" autocomplete="off"/>
        </div>
        
        <div class="col-md-4 ms-2">
        <label for="validationDefault02" class="form-label ms-2"> Image  </label> 
         <input type="file" name="image" id="validationDefault02" accept="image/*"/>
         </div>
         <div class="col-md-4 ms-2">
         <label for="validationDefault03" class="form-label ms-2"> Description   </label>
            <input type="text" name="username" id="validationDefault03" autocomplete="off"/>
        </div>
        <div class="col-md-4 ms-2">
        ...
        <div class="col-md-4 ms-2">
        <label for="validationDefault05" class="form-label ms-2"> Price </label>
          <input type="text" name="username" id="validationDefault05" autocomplete="off"/>
        </div>
